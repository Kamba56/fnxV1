  ...
  return (<main>
    ...
    <div className="flex flex-col lg:flex-row gap-14 p-8 py-20 max-w-7xl m-auto">
      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-6">
          <h2 data-aos="fade-right" data-aos-duration="1200" className="text-3xl font-medium">Our Approach</h2>
          <ol className="flex flex-col gap-4 list-decimal list-inside">
          <p data-aos="fade-right" data-aos-duration="1200" className="text-lg">Our approach to servicing your needs is characterized by:</p>
            <li data-aos="fade-right" data-aos-duration="1200" className="text-lg">
