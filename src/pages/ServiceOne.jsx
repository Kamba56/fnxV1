  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap gap-6">
        ...
        <Card title="Global Reach" text="FNX.IE's international presence and network of industry experts allow us to serve clients globally, facilitating cross-border fund management and asset raising." />
      </div>
    </div>
  )
};
