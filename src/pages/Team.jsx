...
const Team = () => {
  ...
  const members = [
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/andrew-j-s-gebhardt-83513515/?originalSubdomain=uk",
      image: ""
    },
    {
  ...
  return (
    <main className="relative pb-20 text-center">
      ...
      <div className="flex flex-col gap-10 items-center pt-32">
        <article className="max-w-[390px] min-w-72 w-full flex-col items-center p-2 shadow-md lg:shadow-none lg:hover:shadow-md gap-3 flex cursor-pointer pb-7" onClick={() => {handlePop(0)}}>
          <figure className="w-full h-auto max-h-[320px] rounded-lg shadow-md overflow-hidden bg-transparent">
