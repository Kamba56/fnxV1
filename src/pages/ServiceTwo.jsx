...
const ServiceTwo = () => {
  return (
    <div className="flex flex-col gap-6">
      <h2 data-aos="fade-right"  className="text-3xl font-medium">Our Approach</h2>
      <p data-aos="fade-right" className="text-lg">Our approach to servicing your needs is characterized by:</p>
