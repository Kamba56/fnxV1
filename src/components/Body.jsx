...
const HomeBody = () => {
  return (
    <section className="m-auto py-28 px-[5%] max-w-[1440px] flex flex-col gap-14">
      <h2 data-aos="fade-right" className="font-semibold text-4xl">How We Manage And Secure Your Investments </h2>
