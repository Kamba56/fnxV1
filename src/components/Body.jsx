...
const HomeBody = () => {
  return (
    <section className="m-auto py-32 px-7 max-w-[1440px] flex flex-col gap-16">
      ...
      <div className="flex flex-col gap-12 lg:flex-row lg:gap-20 lg:justify-between items-start">
        <article data-aos="flip-left" data-aos-duration="1300" className="flex flex-col gap-7 flex-1">
        ...
        <article data-aos="flip-right" data-aos-duration="1200" className="flex flex-col gap-7 flex-1">
