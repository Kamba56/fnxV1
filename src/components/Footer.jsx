  ...
  return (
    <footer className="flex flex-col lg:flex-row text-white font-light bg-blue-50">
      ...
      <div className="flex-1 pt-10 pb-16 px-[5%] flex lg:hidden flex-col items-start gap-8">
        ...
        <h3 className="font-medium text-lg">Send us an email or give us your information and we wil get back to you.</h3>
        <div className="w-fit">
          <Link data-aos="fade-right" to='/contact' className={`px-12 text-center flex items-center justify-center py-3 text-base font-normal rounded text-white hover:shadow-lg bg-brown-50`}>Contact</Link>
        </div>
