  ...
  return (
    <footer className="flex flex-col gap-16 bg-blue-50 text-white py-20 px-[5%]">
      <div className="flex flex-col gap-5 lg:flex-row items-start lg:justify-between mb-8">
        <Link data-aos="fade-right" data-aos-duration="1000" to='/' className="w-16">
          <img src={logo} alt="Logo" />
        </Link>

        <div data-aos="fade-left" data-aos-duration="1200" className="flex flex-col gap-6">
      ...
      <div data-aos="fade-right" data-aos-duration="1000" className="flex flex-col gap-8">
      ...
      <p data-aos="fade-right" data-aos-duration="1000" className="font-semibold text-sm">©️ 2023 FNX Dublin Limited, All Rights Reserved.</p>
    </footer>
  )
};
