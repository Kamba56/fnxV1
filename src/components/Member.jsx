...
const Member = (props) => {
  ...
  return (
    <article data-aos="fade-up" data-aos-duration="1200" className="max-w-[260px] m-auto pb-8 min-w-72 w-full flex-col gap-3 flex cursor-pointer items-center shadow-md lg:shadow-none lg:hover:shadow-md" onClick={() => {handlePop(number)}}>
